...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/loopy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13738&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/loopy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `loopy` can be installed with:

```
conda install loopy
```

It is possible to list all of the versions of `loopy` available on your platform with:
